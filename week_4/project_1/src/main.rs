fn main() {
    ...
    println!("80 miles to kilometers is {}",kilometer1);
    let kilometer2:f32 = miles2 * 1.609;
    println!("120 miles to kilometers is {}",kilometer2);
    ...
    println!("A car travels {} kilometers/hour if it goes 120 miles in  hours",speed);
